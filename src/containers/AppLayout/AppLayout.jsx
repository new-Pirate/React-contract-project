...
import { CreateUser, RandomUser, Users, ViewUser, EditUser, HooksUsers, HookViewUser, HookEditUser } from '../../pages';
      ...
      <Layout>
        ...
        <Content className="appLayout-content">
          <Switch>
            ...
            <Route path="/hookusers/edit/:id" component={HookEditUser} />
          </Switch>
        </Content>
